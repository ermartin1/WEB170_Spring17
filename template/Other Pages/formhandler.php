...
$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: erin.r.martin@seattlecolleges.edu' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'Email from assignment 1'; // if your client has more than one web site, you can put the site name here.
...
mail ('erin.r.martin@seattlecolleges.edu', $subject, $body, $from);
